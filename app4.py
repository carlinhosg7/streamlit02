            ...
            if dados_filtrados.empty:
                ...
                if gerar_pdf:
                    with st.spinner("🧾 Gerando relatório..."):
                        ...
                        pdf.cell(0, 10, f"Grupo Cliente: {nome_grupo}", ln=True)
                        pdf.cell(0, 10, f"Lojas Atendidas: {total_lojas}", ln=True)
                        pdf.cell(0, 10, f"Período Analisado: {periodo_analise}", ln=True)
                        pdf.cell(0, 10, f"Última Compra: {ultima_compra}", ln=True)
                        pdf.ln(10)
                        ...
                        pdf.set_font("Arial", size=12)
                        for key, val in rfv_resultado.items():
                        ...
                        pdf.set_font("Arial", size=12)
                        for _, row in top_linhas.iterrows():
                        ...
                        graficos = [fig1, fig2, fig3, fig4, fig5]
